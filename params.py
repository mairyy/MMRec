...
def parse_args():
    ...
    parser.add_argument('--model', default='MELT', choices=["MELT"])
    parser.add_argument('--dataset', default='Beauty', help="Datasets")
    ...
    parser.add_argument('--hidden_units', default=32, type=int, help="d")
    ...
    parser.add_argument('--is_samples', default=False, type=bool, help="test with neg items or not")
    parser.add_argument('--n_negative_samples', default=100, type=int)
    
    parser.add_argument('--e_max', default=40, type=int, help="Max epoch")
