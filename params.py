...
def ParseArgs():
    ...
    parser.add_argument('--latdim', default=32, type=int, help='id embedding size')
    ...
    parser.add_argument('--mode', default='graph_t', help='graph with text/vision/mm')
    ...
    parser.add_argument('--knn', default=5, type=int, help='k nearest neighbors')
    parser.add_argument('--img_weight', default=0.5, type=float, help='visual feature weight')
