...
def ParseArgs():
    ...
    parser.add_argument('--f_dim', default=512, type=int, help='dimension of pre-training feature')
    parser.add_argument('--mode', default='text', help='concate text/vision only or multimodal')
